...
export default function Home() {
  ...
  return <main className="min-h-screen bg-background text-foreground">
    ...
    <div className="mx-auto flex max-w-6xl flex-col gap-10 px-5 py-10 sm:px-8 sm:py-16">
      <section className="max-w-3xl"><p className="mb-4 text-sm font-bold uppercase tracking-[0.2em] text-primary">Kulto ni ma&apos;am praxy | terminologies</p><h1 className="text-balance text-4xl font-bold tracking-tight sm:text-6xl">HGE and Soil Mechanics Terminologies</h1><p className="mt-5 max-w-xl text-base leading-7 text-muted-foreground sm:text-lg">For Discord members and RI students ONLY!!</p></section>
